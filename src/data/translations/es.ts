const translations = {
    ...
    more: 'más',
    // More
    more_one: "Soy un desarrollador de software viviendo en Tokio, especializado en la creación de aplicaciones web y nativas.",
    more_two: "Mi objetivo principal radica en la creación de código limpio y altamente mantenible.",
    more_three: "Ansío aplicar mis conocimientos técnicos y mentalidad colaborativa en proyectos atractivos con un impacto positivo. Ya sea para colaborar o simplemente hablar sobre el cambiante panorama tecnológico, estoy siempre dispuesto a charlar.",
    // Skills
    skills_title: "Habilidades",
    skills_desc: "haz click para ver las habilidades ",
    ...
    card_button_two: "Perfil del bot",
    ...
    send_email: "Enviame un email",
    info_footer: "Diseñado y desarrollado por ",
    info_footer_me: "mi",
  };
